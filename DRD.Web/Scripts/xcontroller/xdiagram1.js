        ...
        $("#" + activityId).droppable({
            drop: function (event, ui) {
                ...
                if (ui.draggable.context.id == 'submit-start') {
                    ...
                    $scope.addLink($scope.elmActivityName + "-" + fromIdx, $scope.elmActivityName + "-" + idNo, "REVISI", "Revision", line);
                    ...
                    $scope.addLink($scope.elmCaseName + "-" + fromIdx, $scope.elmActivityName + "-" + idNo, "SUBMITCASE", "", line);
                    ...
                    $scope.addLink($scope.elmPararrelName + "-" + fromIdx, $scope.elmActivityName + "-" + idNo, "SUBMIT", "", line);
                }
            },
