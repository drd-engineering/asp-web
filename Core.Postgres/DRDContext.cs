...
namespace Core.Postgres
{
    public class DRDContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            Price price1 = new Price { CreatedAt= DateTime.Now, Total = 2019192039};

            Usage usage1 = new Usage { CompanyId = listOfCompanyCreated[0].Id, StartedAt=DateTime.Now, ExpiredAt = DateTime.Now.AddDays(package1.Duration)};
            Usage usage2 = new Usage { CompanyId = listOfCompanyCreated[1].Id, StartedAt=DateTime.Now};
            Usage usage3 = new Usage { CompanyId = listOfCompanyCreated[2].Id, StartedAt=DateTime.Now};
