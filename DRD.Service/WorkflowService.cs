...
namespace DRD.Service
{
    public class WorkflowService
    {
        ...
        /// <returns></returns>
        public ICollection<WorkflowListItem> GetWorkflows(long creatorId, string criteria, int page, int pageSize, Expression<Func<WorkflowItem, string>> order = null, bool isActive=true)
        {
