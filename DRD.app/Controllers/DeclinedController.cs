...
{
    public class DeclinedController : Controller
    {
        ...
        public ActionResult DeclinedList(string mid)
        {
            LoginController login = new LoginController();
        ...
        public ActionResult Declined(string mid)
        {
            LoginController login = new LoginController();
            login.CheckLogin(this);
            ...
            if (ids.Length > 1 && !ids[1].Equals("0"))
            {
                ...
                product = psvr.GetById(int.Parse(ids[1]), user.Id);
            }
