...
/***/ (function (module, exports, __webpack_require__) {
    ...
    function getViewerConfiguration() {
        return {
            ...
            debuggerScriptPath: '/Scripts/pdf.js/web/debugger.js'
        };
    }
...
/***/ (function (module, exports, __webpack_require__) {
    ...
    var PDFViewerApplication = {
        ...
        zoomIn: function zoomIn(ticks) {
            return; //xbudi 
            //alert(this.pdfViewer.currentScale);
    ...
    function webViewerKeyDown(evt) {
        return; // disabled by xbudi xbudi
...
/***/ (function (module, exports, __webpack_require__) {
    ...
    if (typeof window !== 'undefined' && window['pdfjs-dist/build/pdf']) {
        ...
        pdfjsLib = require('/Scripts/pdf.js/build/pdf.js');
    }
...
/***/ (function (module, exports, __webpack_require__) {
    ...
    var defaultOptions = {
        ...
        defaultUrl: {
            value: '/doc/mgn/loading.pdf',//'/Scripts/pdf.js/web/xannotation.pdf', //compressed.tracemonkey-pldi-09.pdf',
            kind: OptionKind.VIEWER
        },
        defaultZoomValue: {
            value: '',
        ...
        workerSrc: {
            value: '/Scripts/pdf.js/build/pdf.worker.js',
            kind: OptionKind.WORKER
        }
    };
    {
        ...
        _createClass(PDFPageView, [{
            ...
            value: function cssTransform(target) {
                ...
                if (this.textLayer) {
                    ...
                    //alert(textLayerDiv.style.transform);
                    //xbudi xbudi
                    pdfTransform(this.id, textAbsRotation, scale, scale, transX, transY);
...
/***/ (function (module, exports, __webpack_require__) {
    ...
    PDFPrintService.prototype = {
        ...
        renderPages: function renderPages() {
            ...
            //// xbudi
            //alert('PDFPrintService renderPage');
        ...
        useRenderedPage: function useRenderedPage(printItem) {
            ...
            //// xbudi
            //alert('PDFPrintService useRenderPage');
            return new Promise(function (resolve, reject) {
                img.onload = resolve;
                img.onerror = reject;
            });
        ...
        performPrint: function performPrint() {
            ...
            this.throwIfInactive();
            //// xbudi
            //alert('PDFPrintService performPrint');
