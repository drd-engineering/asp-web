...
namespace DRD.Models.Custom
{
    public class RotationInboxData
    {
        ...
        public System.DateTime? StatusAt { get; set; } // DateUpdated
        ...
        // Reverse navigation
        public virtual System.Collections.Generic.ICollection<RotationUser> RotationUsers { get; set; } // RotaitonUser.FK_RotaitonUser_Rotation
